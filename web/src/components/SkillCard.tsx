  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <h2 className="text-sm font-semibold text-gray-900 group-hover:text-black">{skill.name}</h2>
        {skill.ruleCount > 0 && (
      ...
      {skill.description && <p className="line-clamp-3 text-xs leading-relaxed text-gray-500">{skill.description}</p>}
